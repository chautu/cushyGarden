...
<head>
    ...
    <link href="<?php bloginfo('stylesheet_directory'); ?>/css/classy-nav.css" rel="stylesheet">
    ...
    <link href="<?php bloginfo('stylesheet_directory'); ?>/css/elegant-icon.css" rel="stylesheet">
</head>
<body>
    <!-- Preloader -->
    <div class="preloader d-flex align-items-center justify-content-center">
        ...
        <div class="preloader-img">
            <img src="<?php bloginfo('stylesheet_directory'); ?>/img/core-img/leaf.png" alt="">
        </div>
    </div>
    ...
    <header class="header-area">
                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                                ...
                                <!-- Cart -->
                                <div class="cart">
                                    <a href="<?php bloginfo('url'); ?>/cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Cart <span class="cart-quantity">(1)</span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- ***** Navbar Area ***** -->
        <?php get_template_part('navbar-header'); ?>
    </header>